<script>
  ...
  import { onPrint, calcRT, getPageText } from './Helper.svelte';
    ...
    {:else if showButtons === true}
      <div class="control-start" name="top">
        <div class="line">
          ...
          <Tooltip>
            <span slot="activator" class="button-control" on:click={() => printPdf(url)}>
              <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path
          ...
          <Tooltip>
            <span slot="activator" class="button-control" on:click={() => antiClockwiseRotate()}>
          ...
          <Tooltip>
            <span slot="activator" class="button-control" on:click={() => clockwiseRotate()}>
              <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path
                  d="M14.66 15.66A8 8 0 1 1 17 10h-2a6 6 0 1 0-1.76 4.24l1.42
                  1.42zM12 10h8l-4 4-4-4z"
          ...
          <Tooltip>
            <span slot="activator" class="button-control" on:click={() => downloadPdf(url)}>
              <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          ...
          <Tooltip>
            <span slot="activator" class="page-info button-control" on:click={() => onPageTurn()}>
              <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                {#if autoFlip === true}
